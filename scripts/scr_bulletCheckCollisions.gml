...
var curr_collision = collision_rectangle(x, y, x + hspd, y + vspd, obj_wall, false, false);
...
while (curr_collision != noone) {
    ...
    curr_collision = collision_rectangle(x, y, x + hspd, y + vspd, obj_wall, false, false);
}
